...
export const userListingData = [
  {
    ...
    image:
      "https://cf.bstatic.com/xdata/images/hotel/square600/494798449.webp?k=2400cf2f728f7d8f7cf328ef0460b4630984a01e033c72eb7fea76e22dd8586f&o=",
    title:
      "VicHaus Serviced Apartment VicHaus Serviced Apartment VicHaus Serviced Apartment",
    description: "2118 Thornridge Cir. Syracuse, Connecticut 35624",
    rating: 4.4,
    address: "Elgin State. Celina, Delaware 10299",
    services: {
  ...
  },
  {
    ...
    title:
      "Heritage Collection VicHaus Serviced Apartment VicHaus Serviced Apartment",

    description: "Every unit features a private bathroom and bidet",
    rating: 4.8,
    address:
      "Elgin State. Celina, Delaware 10299 VicHaus Serviced Apartment VicHaus Serviced Apartment",
    services: {
      bed: "1-2",
      bath: "0-1",
      area: "634-940",
  ...
  },
  {
    ...
    rating: 3.8,
    address:
      "Elgin State. VicHaus Serviced Apartment Celina, Delaware 10299 VicHaus Serviced Apartment",
    services: {
      bed: "1-2",
      bath: "0-1",
      area: "634-940",
...
export const ownListingPublishData = [
  {
    id: 1,
    slug: "mohi",
    image:
...
export const ownListingUnpublishData = [
  {
    id: 1,
    slug: "mohi",
    image:
...
export const ownListingDraftData = [
  {
    id: 1,
    slug: "mohi",
    image:
...
export const listingReviewerData = [
  {
    id: 1,
    ...
    description:
      "Lorem Ipsum is simply dummy text of the printitypesetting inLorem I beeindustry's stdummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, ",
  },
  {
    id: 2,
    title: "Kathryn Murphy",
