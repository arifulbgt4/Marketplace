...
import { Link, Paper, Stack, SvgIcon, Typography } from "@mui/material";
...
const Categories: FC<CategoriesProps> = () => {
  return (
    <>
      {" "}
      <Stack gap={4} flexDirection="row" justifyContent="center" mt={3}>
        <Paper
      ...
      <Stack gap={4} flexDirection="row" justifyContent="center" mt={4}>
        <Paper
          sx={{ borderRadius: 2, ":hover": { boxShadow: 10 } }}
          // elevation={0}
          px={2}
