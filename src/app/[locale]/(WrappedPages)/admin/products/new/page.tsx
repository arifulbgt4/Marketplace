...
export default function NewProductPage() {
  ...
  const [variants, setVariants] = useState<VariantForm[]>([
    { sku: "", price: "", compareAtPrice: "", weightGrams: "" },
  ]);
  const [mediaList, setMediaList] = useState<MediaForm[]>([
    { url: "", alt: "" },
  ]);
    ...
    <Box maxWidth={800}>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={6}>
            <TextField
              ...
              fullWidth
              helperText="UUID of existing category"
            />
          </Grid>
        </Grid>
      </Paper>
      ...
      <Paper sx={{ p: 3, mb: 3 }}>
        ...
        {variants.map((v, i) => (
          <Stack key={i} direction="row" spacing={2} mb={1} alignItems="center">
            ...
            />
            {variants.length > 1 && (
              <IconButton onClick={() => removeVariant(i)} size="small">
                <DeleteIcon />
              </IconButton>
            )}
          </Stack>
      ...
      <Paper sx={{ p: 3, mb: 3 }}>
        ...
        >
          ...
          <Button size="small" startIcon={<AddIcon />} onClick={addMedia}>
            Add Image
          </Button>
        </Stack>
        {mediaList.map((m, i) => (
          <Stack key={i} direction="row" spacing={2} mb={1} alignItems="center">
            ...
            />
            {mediaList.length > 1 && (
              <IconButton onClick={() => removeMedia(i)} size="small">
                <DeleteIcon />
              </IconButton>
            )}
          </Stack>
